...
- Use consistent tls library rather than defering to native system lib
...
- Mods installed as symlinks now work correctly.
...
- Enabling a mod cleared the one you enabled just before it
