...
pub fn cave_floor_sheet() -> LoaderConfig {
    LoaderConfig {
        ...
        chunk_map: chunks(&[
            ...
            ("entrance", 0.0, 7.0, 3.0, 9.0),
            ("entrance_shortcut", 0.0, 7.0, 3.0, 9.0),
            ("door", 0.0, 7.0, 3.0, 9.0),
            ("exit", 0.0, 9.5, 3.0, 11.5),
