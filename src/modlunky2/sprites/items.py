...
class ItemSheet(BaseSpriteLoader):
    ...
    _chunk_map = {
        ...
        "climbing_gloves": (4, 2, 5, 3),
        "pitchers_mitt": (5, 2, 6, 3),
        "spike_shoes": (6, 2, 7, 3),
        "spring_shoes": (7, 2, 8, 3),
        "shoes_spike": (6, 2, 7, 3),
        "shoes_spring": (7, 2, 8, 3),
        "cape": (8, 2, 9, 3),
        "jetpack": (9, 2, 10, 3),
        "jetpack_back": (10, 2, 11, 3),
        "back_jetpack": (9, 2, 10, 3),
        "parachute": (11, 2, 12, 3),
        ...
        "gun_webgun": (1, 3, 2, 4),
        "freeze_ray": (2, 3, 3, 4),
        "gun_freezeray": (2, 3, 3, 4),
        "alien_compass": (3, 3, 4, 4),
        "compass_alien": (3, 3, 4, 4),
        ...
        **chunks_from_animation("vlads_cape_worn", (4, 6, 5, 7), 7),
        "kali_ball": (11, 6, 12, 7),
        "punishball": (11, 6, 12, 7),
        "punishball_attach": (11, 6, 12, 7),
        ...
        **chunks_from_animation("gold_bars_shiny", (11, 9, 12, 10), 5),
        ...
        "excalibur_stone_empty": (3, 10, 4, 11),
        "torch": (4, 10, 5, 11),
        ...
        **chunks_from_animation("broken_sword_worn", (4, 12, 5, 13), 3),
        ...
        "seeded_run_unlocker": (11, 12, 12, 13),
        "None13": (12, 12, 13, 13),
        "None14": (13, 12, 14, 13),
        "None15": (14, 12, 15, 13),
        "eggplant_bit": (15, 12, 16, 13),
        "giantfood": (15, 12, 16, 13),
