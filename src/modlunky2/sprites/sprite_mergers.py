...
def get_all_sprite_mergers(entities_json: dict, textures_json: dict, base_path: str):
    return [
        ...
        YanSpriteMerger(entities_json, textures_json, base_path),
        ...
        SpriteMerger(entities_json, textures_json, base_path),
        SpriteMerger(entities_json, textures_json, base_path),
        SpriteMerger(entities_json, textures_json, base_path),
        JumpdogSpriteMerger(entities_json, textures_json, base_path),
        SpriteMerger(entities_json, textures_json, base_path),
        OlmiteNakedSpriteMerger(entities_json, textures_json, base_path),
        OlmitedArmoredSpriteMerger(entities_json, textures_json, base_path),
        OlmiteHelmetSpriteMerger(entities_json, textures_json, base_path),
