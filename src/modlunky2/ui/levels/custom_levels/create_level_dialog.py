...
def present_create_level_dialog(modlunky_config, backup_dir, lvls_path, current_save_format, on_level_created):
        ...
        create_save_format = (
            current_save_format
            or modlunky_config.custom_level_editor_default_save_format
        )
